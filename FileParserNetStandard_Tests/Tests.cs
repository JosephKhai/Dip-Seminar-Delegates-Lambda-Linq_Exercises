...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = @"D:\GitHub\Delegates_Lambda_Linq_Exercise\Files\data.csv";  // change to appropriate path
        private string _tsvPath = @"D:\GitHub\Delegates_Lambda_Linq_Exercise\Files\data.tsv";  // change to appropriate path

        private string _writeFile = @"D:\GitHub\Delegates_Lambda_Linq_Exercise\Files\dataWrite.txt";  // change to appropriate path
